  ...
  return (
    <motion.header 
      className={`fixed top-0 left-0 right-0 z-50 py-4 transition-all duration-300 ${
        scrolled 
          ? "dark:bg-section-dark/90 bg-white/90 backdrop-blur-sm shadow-sm" 
          : "dark:bg-section-dark/20 bg-transparent"
      }`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
      ...
      {menuOpen && (
        <motion.div
          ...
          className="md:hidden bg-white dark:bg-section-dark shadow-md"
        >
